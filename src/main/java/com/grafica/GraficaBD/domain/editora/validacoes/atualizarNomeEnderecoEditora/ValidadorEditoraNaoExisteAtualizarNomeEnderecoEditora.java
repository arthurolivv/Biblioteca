...
import com.grafica.GraficaBD.domain.editora.validacoes.detalharEditora.ValidadorEditoraNaoExiste;
...
@Component
public class ValidadorEditoraNaoExisteAtualizarNomeEnderecoEditora implements ValidadorAtualizarNomeEnderecoEditora {

    @Autowired
    private EditoraRepository editoraRepository;

    @Override
    public void validar(Long id, AtualizarNomeEnderecoDaEditoraDto atualizarNomeEnderecoDaEditoraDto) {
